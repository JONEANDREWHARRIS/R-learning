...
reddit_wbpg <- read_html("https://www.reddit.com/r/politics/comments/nntj06/calls_mount_for_biden_to_form_presidential_16/")
...
reddit_recent_data <- reddit_newspgs_times[grep("minutes ago|1 hour ago", reddit_newspgs_times$PublishedTime),]
...
plot(average_sentiment_score)

# Email the results of the analysis
install.packages("sendmailR")
library(sendmailR)
from <- "<gamingfun21.04.2001@gmail.com>"
to <- "<gamingfun21.04.2001@gmail.com>"
